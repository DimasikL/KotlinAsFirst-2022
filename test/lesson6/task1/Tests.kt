...
class Tests {
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("", dateDigitToStr("01.13.1"))
        assertEquals("", dateDigitToStr(""))
        assertEquals("", dateDigitToStr("a"))
    }
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(3, firstDuplicateIndex("Мы пошли пошли"))
    }
    ...
    fun mostExpensive() {
        ...
        assertEquals("a", mostExpensive("b 0; a 0"))
    ...
    fun fromRoman() {
        ...
        assertEquals(2009, fromRoman("MMIX"))
        assertEquals(1765, fromRoman("MDCCLXV"))
