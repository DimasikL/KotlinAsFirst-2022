 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg+min/60+sec/3600)/(180/ PI)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (((initial*(100+percent)/100*(100+percent)/100*(100+percent)/100).toDouble()))
