...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double =
    deg * PI / 180 + min * PI / (60 * 180) + sec * PI / (180 * 60 * 60)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * ((100.0 + percent) / 100.0).pow(3)
